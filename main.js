...
const smallSize = matchMedia("(max-width: 767px)"),
  ...
  smallSizeImgPaths = [
    ...
    "src/Mobile/Portfolio thumbnails/FEV.png",
    "src/Mobile/Portfolio thumbnails/Portfolio.png",
    "src/Mobile/Portfolio thumbnails/Chuck-Norris-Jokes.png",
    "src/Mobile/Portfolio thumbnails/VueMiniYoutubePlayer.png",
  ],
  tabletSizeImgPaths = [
    "src/Desktop/Illustrations-SVG/Code navbar icon.svg",
    "src/Tablet/Portfolio Thumbnails/L'indécis.png",
    "src/Tablet/Portfolio Thumbnails/FEV.png",
    "src/Tablet/Portfolio Thumbnails/Portfolio.png",
    "src/Tablet/Portfolio Thumbnails/Chuck-Norris-Jokes.png",
    "src/Tablet/Portfolio Thumbnails/VueMiniYoutubePlayer.png",
  ],
  desktopSizeImgPaths = [
    "src/Desktop/Illustrations-SVG/Code navbar icon.svg",
    "src/Desktop/Portfolio thumbnails/L'indécis.png",
    "src/Desktop/Portfolio thumbnails/FEV.png",
    "src/Desktop/Portfolio thumbnails/Portfolio.png",
    "src/Desktop/Portfolio thumbnails/Chuck-Norris-Jokes.png",
    "src/Desktop/Portfolio thumbnails/VueMiniYoutubePlayer.png",
  ],
